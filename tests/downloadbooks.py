            ...
            if match:
                ...
                if not os.path.isfile(zip_file_path):
                    ...
                    try:
                        ...
                        print(f"Downloaded {book_id}.zip successfully to {download_folder}.")
                ...
                if not os.path.exists(book_extraction_folder):
                    try:
                        ...
                        print(f"Error unzipping {book_id}.zip: The file may be corrupt or not a zip file.")
                else:
                    print(f"Extraction folder for {book_id} already exists. Skipping extraction.")
            else:
